                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Image.asset('assets/images/dc_avatar.png', fit: BoxFit.cover,),
                                  ),
                                ),
                                const SizedBox(
                                  width: 150,
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Align(
                                    alignment: Alignment.centerLeft,
                                    child: Text("DOB : ${value.doctorAge}",
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.only(left: 30),
                                child: Align(alignment: Alignment.centerLeft,child: Text("Speciality: ${value.chosenSpec}", style: const TextStyle(fontSize: 19),)),
                              )
                            ],
                          ),
                        ),

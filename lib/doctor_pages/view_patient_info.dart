...
import 'package:clinica_clone/doctor_pages/doctor_patient_profile_view.dart';
...
class _PatientInfoViewState extends State<PatientInfoView> {
  @override
  Widget build(BuildContext context) {
    return Consumer<PickedDate>(builder: (context, value, child) => Center(
      child: Container(
                ...
                child: Image.asset('assets/images/avatar.png', fit: BoxFit.cover,),
                  ...
                  Positioned(
                    ...
                    child: TextButton(
                      ...
                      onPressed: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => const DoctorPatientProfileView(),));
                      },
